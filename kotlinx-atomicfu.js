(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).gv = function () {
    return this.fv_1.length;
  };
  ...
  protoOf(AtomicRef).hv = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).iv = function () {
  ...
  protoOf(AtomicInt).jv = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).iv = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicBoolean).kv = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).iv = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).lv = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).iv = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).gv);
  //endregion
